...
<form method="post" class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="text" id="title" name="title" placeholder="Titre" value="<?php echo $book->getTitle() ?>">
    </div>

    <div class="mb-3">
        <label for="resume">Résumé</label>
        <textarea class="form-control" id="resume" name="resume" rows="3" placeholder="Résumé"><?php echo $book->getResume() ?></textarea>
    </div>

    <div class="mb-3">
        <label for="author_id">Auteur</label>
        <select class="form-select">
            <?php echo $selectAuthors ?>
        </select>
    </div>
